...
const TestDBConnection = () => {
  ...
  const testConnection = async () => {
    ...
    try {
      const response = await axios.get(getApiUrl("/api/test/test-db"));
  ...
  const fetchUsers = async () => {
    ...
    try {
      const response = await axios.get(getApiUrl("/api/test/test-users"));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(getApiUrl("/api/test/test-insert"), formData);
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="p-4 border rounded-lg bg-yellow-50">
        ...
        <div className="space-y-4">
          ...
          <div>
            <h3 className="font-medium text-yellow-800">
              Need to create the users table?
            </h3>
