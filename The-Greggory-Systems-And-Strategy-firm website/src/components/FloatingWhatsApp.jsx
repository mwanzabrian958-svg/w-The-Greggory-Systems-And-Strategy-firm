...
const FloatingWhatsApp = () => {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[60] group">
      ...
      <div className="absolute inset-0 bg-green-500 rounded-full animate-pulse opacity-10 scale-125"></div>
      ...
      <div className="absolute bottom-full right-0 mb-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 pointer-events-none">
        <div className="bg-[#0f1f3d] text-white text-[10px] font-black uppercase tracking-[0.2em] px-4 py-2 rounded-xl shadow-2xl border border-white/10 whitespace-nowrap">
          Strategic Support
        </div>
        <div className="w-3 h-3 bg-[#0f1f3d] border-r border-b border-white/10 rotate-45 absolute -bottom-1.5 right-6"></div>
      </div>
      ...
      <a
        ...
        className="relative flex items-center justify-center h-16 w-16 bg-gradient-to-br from-green-500 to-green-600 text-white rounded-[20px] shadow-[0_20px_40px_-10px_rgba(34,197,94,0.5)] transition-all duration-500 hover:scale-110 hover:rotate-6 active:scale-95 group"
        aria-label="Chat on WhatsApp"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-8 h-8 fill-current drop-shadow-md">
