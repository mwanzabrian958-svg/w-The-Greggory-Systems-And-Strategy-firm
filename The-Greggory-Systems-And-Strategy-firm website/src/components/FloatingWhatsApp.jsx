  ...
  return (
    <div className="fixed bottom-5 right-5 z-[60] group">
      ...
      <div className="absolute bottom-full right-0 mb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
        <div className="bg-[#0f1f3d] text-white text-[9px] font-black uppercase tracking-[0.2em] px-3 py-1.5 rounded-lg shadow-xl border border-white/10 whitespace-nowrap">
          Strategic Support
        </div>
        <div className="w-2.5 h-2.5 bg-[#0f1f3d] border-r border-b border-white/10 rotate-45 absolute -bottom-1 right-4"></div>
      </div>
      ...
      <a
        ...
        className="relative flex items-center justify-center h-11 w-11 bg-green-600 text-white rounded-full shadow-lg transition-all duration-300 hover:bg-green-500 hover:scale-105 active:scale-95"
