...
export function UserDetail() {
  ...
  return (
    <div className="fixed inset-0 bg-[#020617] z-[500] flex flex-col font-sans text-white overflow-hidden animate-in fade-in duration-300 print:bg-white print:text-black print:relative print:inset-auto print:h-auto print:overflow-visible">
      ...
      <div className="h-16 border-b border-white/5 flex items-center justify-between px-6 bg-[#0f172a]/50 backdrop-blur-xl no-print">
         ...
         <div className="flex items-center gap-3">
            <button
              onClick={handlePrint}
              className="flex items-center gap-2 px-4 py-2 bg-teal-600/10 hover:bg-teal-600 text-teal-500 hover:text-white border border-teal-600/20 rounded-xl text-[8px] font-black uppercase tracking-widest transition-all shadow-lg group"
            >
              ...
              <div className="lg:col-span-8 space-y-8">
                    ...
                    <div className="relative z-10">
                       ...
                       <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                          {[
                            ...
                            <div key={stat.label}>
                               ...
                               <p className="text-[10px] font-black text-white uppercase truncate">{stat.val}</p>
                            </div>
                          ))}
                       </div>
                       <div className="mt-8 grid md:grid-cols-2 gap-8 pt-8 border-t border-white/5">
                          <div>
                            ...
                            <div className="bg-white/2 p-6 rounded-3xl border border-white/5 italic text-slate-400 text-[10px] leading-relaxed h-32 overflow-y-auto">
                              {user.mission_briefing || "No mission briefing recorded."}
                            </div>
                          </div>
                          <div>
                            <p className="text-[7px] font-black text-rose-500 uppercase tracking-widest mb-3">Internal Company Notes (Restricted)</p>
                            <div className="bg-rose-500/5 p-6 rounded-3xl border border-rose-500/10 text-slate-300 text-[10px] leading-relaxed h-32 overflow-y-auto">
                 ...
                 <div className="bg-slate-900/30 border border-white/5 rounded-[40px] p-8">
                    <div className="flex items-center justify-between mb-8">
                       <div className="flex items-center gap-3 text-blue-400"><Briefcase size={18} /><h4 className="text-[11px] font-black uppercase tracking-widest">Deployments & Projects</h4></div>
                    </div>

                    {/* Manual Project Node */}
                    {user.manual_projects && (
                      <div className="mb-6 p-6 bg-amber-500/5 border border-amber-500/10 rounded-3xl">
                        <p className="text-[7px] font-black text-amber-500 uppercase tracking-widest mb-2">Legacy / Manual Project References</p>
                        <p className="text-[10px] text-slate-300 italic leading-relaxed">{user.manual_projects}</p>
                      </div>
                    )}
