...
const Projects = () => {
  ...
  const renderSection = () => {
    ...
    switch (activeSection) {
      ...
      case 'notifications':  content = <NotificationsSection user={user} notifs={notifs} isLoading={isLoading} onToggleRead={toggleNotifRead} onAcknowledgeAll={acknowledgeAllNotifs} onRefresh={fetchData} />; break
