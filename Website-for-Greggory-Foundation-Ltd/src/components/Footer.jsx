          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="w-1 h-1">
                <Link to="/admin" className="block w-full h-full opacity-0 hover:opacity-0">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:thegregoryfoundationltd@gmail.com" className="text-gray-300 hover:text-teal-400 transition-colors">
                  thegregoryfoundationltd@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-center justify-center mt-2">
                <Link to="/admin" className="relative group">
                  <div className="w-8 h-4 bg-white/10 backdrop-blur-sm border border-gray-300/30 rounded-sm shadow-lg hover:bg-white/20 transition-all duration-300 cursor-pointer">
