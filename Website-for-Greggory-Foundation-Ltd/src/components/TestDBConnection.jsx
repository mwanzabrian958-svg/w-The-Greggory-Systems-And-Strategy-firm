...
const TestDBConnection = () => {
  ...
  const testConnection = async () => {
    ...
    try {
      const response = await axios.get('http://localhost:8080/api/test/test-db');
  ...
  const fetchUsers = async () => {
    ...
    try {
      const response = await axios.get('http://localhost:8080/api/test/test-users');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('http://localhost:8080/api/test/test-insert', formData);
