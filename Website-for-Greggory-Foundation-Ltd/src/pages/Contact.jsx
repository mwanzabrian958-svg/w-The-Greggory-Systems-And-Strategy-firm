...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (preferredChannel === 'email') {
      window.location.href = `mailto:thegregoryfoundationltd@gmail.com?subject=${encodeURIComponent(subject)}&body=${body}`
    } else {
  ...
  const contactInfo = [
    {
      ...
      title: 'Email Us',
      content: 'thegregoryfoundationltd@gmail.com',
      link: 'mailto:thegregoryfoundationltd@gmail.com'
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="font-semibold text-navy-900 mb-4">Company Showcase</h3>
