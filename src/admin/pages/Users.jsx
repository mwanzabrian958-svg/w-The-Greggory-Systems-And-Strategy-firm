              ...
              {loading ? (
                ...
                paginatedUsers.map((u) => (
                  <tr key={u.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getRoleBadgeClass(u.admin_level || u.developer_level || u.primary_role)}`}
                      >
                        {getRoleIcon(
                          u.admin_level || u.developer_level || u.primary_role,
                        )}
                        <span className="ml-1">
                          {u.admin_level ||
                            u.developer_level ||
