                ...
                <div className="bg-slate-50 rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input type="text" defaultValue="greggory_foundation" className="w-full px-4 py-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none" />
                    </div>
