...
const AuthLayout = ({ children, title, subtitle }) => {
  return (
    <div className="min-h-screen bg-[#07111f] relative overflow-hidden flex flex-col items-center justify-center px-4 py-4 sm:py-8">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-6">
          <div className="flex justify-center mb-4">
            <div className="relative group">
              <div className="absolute -inset-4 bg-amber-500/20 rounded-full blur-2xl group-hover:bg-amber-500/40 transition-all duration-700" />
              <img
        ...
        <div className="bg-white/5 backdrop-blur-2xl py-6 px-6 shadow-2xl rounded-[32px] border border-white/10 sm:px-10 relative overflow-hidden">
          ...
          <div className="absolute -top-24 -right-24 h-48 w-48 bg-amber-500/10 blur-[80px] rounded-full pointer-events-none" />
          {children}
        </div>
      </div>
    </div>
